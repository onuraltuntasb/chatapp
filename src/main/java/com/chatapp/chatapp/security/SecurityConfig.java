...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
       ...
       /* http.oauth2Login(oauth2 -> oauth2
                                 .defaultSuccessUrl("/api/user/register-oauth")
                        ).logout(oauth2 -> oauth2.logoutSuccessUrl("/api/user/logout-oauth"));*/
    ...
    CorsConfigurationSource corsConfigurationSource() {
        CorsConfiguration configuration = new CorsConfiguration(); configuration.setAllowedOrigins(
                Arrays.asList("http://localhost:3000","https://accounts.google.com")); configuration.setAllowedMethods(
